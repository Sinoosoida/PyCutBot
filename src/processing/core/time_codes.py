...
def _check_buff_8(b):
    return b[2] == ':' and b[5] == ':' and \
           b[0:2].isdigit() and b[3:5].isdigit() \
           and b[6:].isdigit() and int(b[3:5]) <= 60 and int(b[6:]) <= 60


def _check_buff_7(b):
    return b[1] == ':' and b[4] == ':' and \
           b[0].isdigit() and b[2:4].isdigit() \
           and b[5:].isdigit() and int(b[2:4]) <= 60 and int(b[5:]) <= 60
